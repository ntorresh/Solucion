...
\ memory map i2c:
h# 7100 constant prerl
h# 7102 constant prerh
h# 7104 constant ctr
h# 7106 constant rxr 		\ write is transmit register (txr)
h# 7108 constant sr 		\ write is command register (cr)
h# 710A constant txr
h# 710C constant cr
h# 710C constant 0_res   	\ reserved
